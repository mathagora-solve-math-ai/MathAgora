export type UploadedImage = {
  ...
  /** Fallback detections in normalized (0–1) coordinates for any image when API returns none. */
  export const getFallbackDetections = (): Detection[] => [
    { id: "p1", x: 0.1, y: 0.15, w: 0.78, h: 0.12, label: "Problem 1" },
    { id: "p2", x: 0.1, y: 0.32, w: 0.7, h: 0.12, label: "Problem 2" },
    { id: "p3", x: 0.1, y: 0.5, w: 0.85, h: 0.12, label: "Problem 3" },
    { id: "p4", x: 0.1, y: 0.67, w: 0.6, h: 0.12, label: "Problem 4" },
  ];
